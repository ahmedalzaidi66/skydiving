/*
  ...
  The table was defined in a prior migration file but never applied to the database.
  This migration creates the table, enables RLS, adds policies, and seeds the 6 default rows.

  ## New Table
  - `ui_size_settings`
    - `id` (uuid, primary key)
    - `category` (text, unique) — global | header | search | filter | product_card | bottom_nav
    - `label` (text)
    - `mobile` (jsonb)
    - `tablet` (jsonb)
    - `desktop` (jsonb)
  ...
  - anon + authenticated INSERT/UPDATE (admin writes without Supabase Auth)
*/
